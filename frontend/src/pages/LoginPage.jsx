...
import { ArrowRight, Eye, EyeOff, Loader, Lock, User, Facebook, Github, Globe } from "lucide-react";
      ...
      >
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center gap-6 mt-4">
            <button type="button" className="p-3 bg-gray-100 rounded-full cursor-pointer  hover:bg-gray-200 transition duration-200">
